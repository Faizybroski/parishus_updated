    ...
    <Sheet>
      <SheetTrigger asChild>
        <Button
          variant="outline"
          size="sm"
          className="relative group border-none bg-transparent hover:bg-transparent hover:text-primary text-muted-foreground"
        >
          <Bell className="h-5 w-5" />
          {unreadCount > 0 && (
            <Badge className="absolute -top-1 -right-1 h-5 w-5 rounded-full p-0 text-background text-xs flex items-center justify-center icon-animate">
      ...
      <SheetContent className="w-[370px] sm:w-[540px]" id="notificationSheet">
        <SheetHeader>
          <SheetTitle className="flex items-center justify-between">
            <span className="font-script">Notifications</span>
            {unreadCount > 0 && (
              <Button
                variant="ghost"
                size="sm"
