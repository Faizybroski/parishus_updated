...
export default function SafetyGuidelines() {
  return (
    <section className="min-h-screen text-gray-400 py-16 px-6 lg:px-12">
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <div className="text-center mb-16">
          <h1 className="text-4xl lg:text-5xl text-black font-bold mb-4 font-script">
        ...
        <div className="space-y-16">
          {/* Getting Ready */}
          <div>
            <h2 className="flex items-center gap-3 text-2xl font-semibold text-primary mb-6">
              <UtensilsCrossed className="h-7 w-7 text-primary" /> Getting Ready for Your Dinner
            </h2>
          ...
          <div>
            <h2 className="flex items-center gap-3 text-2xl font-semibold text-primary mb-6">
              <Users className="h-7 w-7 text-primary" /> During the Experience
            </h2>
            <ul className="space-y-3 text-gray-400">
          ...
          <div>
            <h2 className="flex items-center gap-3 text-2xl font-semibold text-primary mb-6">
              <Heart className="h-7 w-7 text-primary" /> Respect & Conduct
            </h2>
            <ul className="space-y-3 text-gray-400">
          ...
          <div>
            <h2 className="flex items-center gap-3 text-2xl font-semibold text-primary mb-6">
              <ShieldCheck className="h-7 w-7 text-primary" /> Safety Reminders
            </h2>
            <ul className="space-y-3 text-gray-400">
          ...
          <div>
            <h2 className="flex items-center gap-3 text-2xl font-semibold text-primary mb-6">
              <Camera className="h-7 w-7 text-primary" /> Photos & Memories
            </h2>
          ...
          {/* Emergency */}
          <div className="border border-red-500/40 rounded-2xl p-6 shadow-xl">
        ...
        <div className="text-center mt-16">
          <p className="text-lg text-gray-400">
            ✨ By following these guidelines, you help create the warm, respectful, and enjoyable dining culture that makes <span className="text-primary font-medium">parish</span> unique.  
