...
const AddPlan = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast({
      title: 'Plan created!',
      description: `Your "${formData.name}" plan was created successfully.`,
    });
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="mb-6">
          <Button variant="ghost" onClick={handleCancel} className="mb-4 flex items-center space-x-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 bg-card p-6 rounded-xl shadow-md">
          <div>
