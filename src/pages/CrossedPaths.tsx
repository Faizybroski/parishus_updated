        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-sm sm:text-base text-muted-foreground mt-1">
              People you've crossed paths with at restaurants within the last 14
              days
            </p>
          </div>
          ...
          {crossedPaths.length === 0 ? (
            <Card className="shadow-card border-border w-full">
              <CardContent className="py-8 sm:py-12 px-4 sm:px-6 text-center">
                ...
                <p className="text-sm sm:text-base text-muted-foreground">
                  Visit restaurants to discover people you've crossed paths
                  with. Enable tracking in your Profile settings.
                </p>
              </CardContent>
            </Card>
          ) : (
            <div className="grid gap-4 sm:gap-6">
              {crossedPaths.map((path) => (
                <Card
                  key={path.id}
                  className="shadow-card border-border w-full"
                >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                      <div className="flex items-start space-x-4">
                        <Avatar className="h-14 w-14 sm:h-16 sm:w-16">
                          <AvatarImage
                            src={path.matched_user.profile_photo_url}
                          />
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="text-base sm:text-lg font-semibold text-foreground">
                            ...
                            {path.payment_status === "completed" ? (
                              <span className="px-3 py-1 text-xs font-semibold text-black bg-yellow-400 rounded-full ml-4">
                                🌟 Paid
                              </span>
                            ) : (
                              <span className="px-3 py-1 text-xs font-semibold text-white bg-[rgb(0,30,83)] rounded-full ml-4">
                                🆓 Free
                              </span>
                            )}
                          </h3>
